    ...
    <div>
      ...
      <div class="mt-4 flex justify-center">
        <a
          ...
          class="imperial-label inline-flex items-center rounded-sm border border-papyrus-dark/40 bg-papyrus-dark/20 px-5 py-2 text-ink/60 transition-all hover:border-rubric/40 hover:bg-papyrus hover:text-rubric"
        >
          Wikipedia
        </a>
      </div>
